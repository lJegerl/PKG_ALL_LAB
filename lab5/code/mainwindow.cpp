...
{
    LayoutSettings();
    this->pbAveragePoint->setEnabled(false);
    this->pbMnogoyg->setEnabled(false);
    connect (this->pbOpenFile,SIGNAL(clicked()),SLOT(readFile()));
    connect (this->pbAveragePoint,SIGNAL(clicked()),SLOT(averagePoint()));
    connect (this->pbMnogoyg,SIGNAL(clicked()),SLOT(kirusBack()));
...
void MainWindow::LayoutSettings()
{
    ...
    this->boxbuttons->addWidget(this->pbAveragePoint);
...
void MainWindow::readFile()
{
  ...
  if (file.open(QIODevice::ReadOnly))
  {
      ...
      {
          this->pbMnogoyg->setEnabled(false);
          this->pbAveragePoint->setEnabled(true);
